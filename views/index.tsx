  ...
  return (
    <React.Fragment>
      ...
      <div id='page'>
        ...
        <header id='fh5co-header' className='fh5co-cover' role='banner' style={{backgroundImage: 'url(images/img_bg_2.jpg)'}}
            ...
            <div className='row row-bottom-padded-md'>
              <div className='col-md-12'>
                <ul id='fh5co-gallery-list'>
                  ...
                  <li className='one-third animate-box' data-animate-effect='fadeIn'
                      style={{backgroundImage: 'url(images/gallery-7.jpg)'}}>
                    <a href='#' className='color-4'>
                      <div className='case-studies-summary'>
                        <span>35 Photos</span>
                        <h2>Two Glas of Juice</h2>
                  ...
                  <li className='one-third animate-box' data-animate-effect='fadeIn'
                      style={{backgroundImage: 'url(images/gallery-9.jpg)'}}>
              ...
              <div className='display-t'>
                <div className='display-tc'>
                  <div className='col-md-3 col-sm-6 animate-box'>
                    <div className='feature-center'><span className='icon'><i className='icon-users'></i></span>
                  ...
                  <div className='col-md-3 col-sm-6 animate-box'>
                    <div className='feature-center'><span className='icon'><i className='icon-user'></i></span>
                  ...
                  <div className='col-md-3 col-sm-6 animate-box'>
                    <div className='feature-center'><span className='icon'><i className='icon-calendar'></i></span>
                  ...
                  <div className='col-md-3 col-sm-6 animate-box'>
                    <div className='feature-center'><span className='icon'><i className='icon-clock'></i></span>
                    ...
                    <div className='owl-carousel-fullwidth'>
                      ...
                      <div className='item'>
                        <div className='testimony-slide active text-center'>
                          ...
                          <span>John Doe, via <a href='#' className='twitter'>Twitter</a></span>
                          <blockquote>
                            <p>'Far far away, far from the countries Vokalia and Consonantia, there live the blind texts.
          ...
          <div className='container'>
            ...
            <div className='row'>
              <div className='col-md-6'>
                ...
                <div className='feature-left animate-box' data-animate-effect='fadeInLeft'>
                  <span className='icon'><i className='icon-video'></i></span>
                  <div className='feature-copy'>
                    <h3>Video Editing</h3>
                    <p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit. Eos cumque dicta
                      adipisci architecto culpa amet.</p>
              ...
              <div className='col-md-6 animate-box'>
                <div className='fh5co-video fh5co-bg' style={{backgroundImage: 'url(images/img_bg_3.jpg)'}}>
                  <a href='https://vimeo.com/channels/staffpicks/93951774' className='popup-vimeo'><i
                    className='icon-video2'></i></a>
                  <div className='overlay'></div>
                </div>
              </div>
            </div>
